...
#[proc_macro]
pub fn make_signature(item: proc_macro::TokenStream) -> proc_macro::TokenStream {
    make_signature2(item.into()).into()
}

fn make_signature2(item: proc_macro2::TokenStream) -> proc_macro2::TokenStream {
